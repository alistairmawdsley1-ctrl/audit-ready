        ...
        <div className="flex-1 flex flex-col justify-center py-24 max-w-4xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="sm:col-span-2 bg-black rounded-xl p-8">
              ...
              <h3 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "1.875rem", fontWeight: 500, color: "#fff", letterSpacing: "-0.02em", lineHeight: 1.2, marginBottom: "1rem" }}>A structured 60-minute conversation.</h3>
            ...
            <div className="sm:col-span-2 bg-zinc-100 rounded-xl p-8 border border-zinc-200">
              <p className="text-xs tracking-widest text-zinc-400 mb-4">04 — 90-day action plan</p>
              <h3 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: '1.875rem', fontWeight: 400, color: '#111', letterSpacing: '-0.02em', lineHeight: 1.2, marginBottom: '1.5rem' }}>Phased. Prioritised. Board-ready.</h3>
