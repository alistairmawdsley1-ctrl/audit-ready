...
export function mapSlotsToRegimes(slots, citations) {
  ...
  if (slots.decision_making === "yes") {
    triggered.push({
      ...regimes.ehrc,
      trigger_reason:
        "Your AI system makes or influences decisions about individuals. This engages Equality Act 2010 obligations around indirect discrimination. If the system produces outcomes that disproportionately disadvantage a protected group — even without discriminatory intent — it may be unlawful. Ongoing bias monitoring and documentation are required.",
    });
  }
